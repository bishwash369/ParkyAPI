...
{ 
    public class TrailRepository : ITrailRepository
    {
        ...
        {
            _db.Trails.Add(trail);  //_db helps us access DbContext
            return Save();
        }
        ...
        {
            return _db.Trails.Include(c => c.NationalPark).FirstOrDefault(a => a.Id == trailId); //returns only one obj/value Id.
        }
